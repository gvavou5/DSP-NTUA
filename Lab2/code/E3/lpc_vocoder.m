function [s_lpc] = lpc_vocoder(s,a,winlen,G,pitch)
...
[S,F,T,P] = spectrogram(s, w, 480, nextpow2(siglen), Fs);
surf(T,F,10*log10(P),'edgecolor','none'); axis tight; 
view(0,90);
title('Spectogram of Natural Voice');

subplot(2,1,2);
[S,F,T,P] = spectrogram(s_lpc, w, 480, nextpow2(siglen), 48000);
surf(T,F,10*log10(P),'edgecolor','none'); axis tight; 
view(0,90);
